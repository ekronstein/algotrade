...
from algotrade.common.data_models import CurrencyPair, Order, currency_pair_from_str
...
class BSDEX:
    ...
    def get_pairs(self) -> dict[MarketName, set[CurrencyPair]]:
        ...
        """
        return {MarketName('bsdex'): set([currency_pair_from_str('btc-eur'), currency_pair_from_str('btc-usd')])}
